...
namespace Asv.Tools
{
    public static class ConsoleWelcomePrinter
    {
        ...
        public static string PrintWelcome(this Assembly src, IEnumerable<KeyValuePair<string, string>> additionalValues = null)
        {
            ...
            {
                new KeyValuePair<string, string>("Version",src.GetInformationalVersion() ),
#if DEBUG
                new KeyValuePair<string, string>("Build","Debug" ),
#else
                new KeyValuePair<string, string>("Build", "Release"),
#endif
                new KeyValuePair<string, string>("Process",Process.GetCurrentProcess().Id.ToString()),
                ...
                new KeyValuePair<string, string>("Environment",Environment.Version.ToString()),
            };
